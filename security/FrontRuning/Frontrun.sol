...
/*
	...
	区块中的交易来获得一定的利润, 而MEV是衡量这种利润的指标;

	MEV(最大化交易价值): 
	指通过在交易执行过程中获取的附加价值, 这些附加价值可以超过单纯的交易
	手续费; MEV 通常源于区块链上的交易顺序, 交易池和共识机制等因素; MEV
	是指那些由于交易顺序和挖矿策略等因素引起的, 与区块链交易有关的附加价值;
	MEV 的产生方式主要分为两类:
	1. 顺序提升: 通过改变交易的执行顺序, 使得挖矿者在交易过程中获得更多的
		附加价值
	2. 交易捕捉: 通过发现和利用交易池中存在的低成本交易, 从而获得更多的附加价值

	MEV一方面为挖矿者提供了一种额外的收益方式, 从而提高了他们的收入, 同时也会对
	区块链交易的可靠性和公平性产生影响; 另一方面, MEV 也可能导致交易费用的增加,
	同时也可能会引起市场中的不公平竞争
